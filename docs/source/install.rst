...
Windows and MacOS executables are available for all major releases on `GitHub <https://github.com/djdt/spcal/releases>`_.
...
.. note::
   From spcal version 2.0.0 onwards the `oneTBB <https://github.com/uxlfoundation/oneTBB>`_ C++ library is required.
