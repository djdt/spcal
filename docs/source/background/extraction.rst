...
Closely approximating the signal produced by a TOF using a compound-Poisson-lognormal distribution allows the use of our and :ref:`lookup table<Lookup Table>` method.
...
This method requires concurrent measurement of a 1 - 10 ppb ionic standard, as is typically used for calibration.
